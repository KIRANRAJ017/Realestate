            ...
            <div className="track">
               ...
               <div className="det">
                   <div className="otpnum" style={{paddingTop:"40px",paddingRight:"40px"}}>
                       ...
                       <Link href="/Residential/Owner/profile"><button className="needbut1" style={{marginTop:'20px'}}>Continue</button><br/></Link>
                   </div>
                   <div className="need" style={{backgroundColor:' rgba(30, 146, 188, 0.187)',width:'22vw'}}>
                       <p>Describe your property i brief so the buyer or renter can easily get to know how your property is what makes your property different from others.</p>
