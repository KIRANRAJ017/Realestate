        ...
        <>
            ...
            <div className="otp">
                <div className="otpnum" style={{paddingTop:"40px",paddingBottom:"60px"}}>
                    ...
                    <Link  href={data=="owner"?"/Residential/Owner/detail":data=="agent"?"/Residential/Agent/agent":"/Residential/Builder/detail"}><button className="needbut1">Continue</button><br/></Link>
                </div>
