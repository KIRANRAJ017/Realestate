        ...
        <>
            ...
            <div className="track">
                   ...
                   <div className="trackele">
                       <p style={{color:'blue'}}>Basic Details</p>
                       <p style={{color:'blue'}}>Location Details</p>
                       <p style={{color:'blue'}}>Property Details</p>
                       <p style={{color:'blue'}}>Photos</p>
                       <p>Pricing & Others</p>
                   </div>
               </div>
               <div className="det">
                   <div className="otpnum" style={{paddingRight:"40px"}}>
                       ...
                       <div  className="check">
                        ...
                        <Link href="/Residential/Agent/photos"><button className="needbut1">Continue</button></Link>
                   </div>
